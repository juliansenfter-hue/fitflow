...
(function () {
  ...
  const notifications = [
    ...
    { id: 'n3', type: 'event', icon: 'trophy', title: `\u00d6tztaler in ${weeksToOtz} Wochen`, text: `Form-Prognose aktualisiert: \u00d6tztaler am ${fmt.date(otzDate)} \u2014 Taper rechtzeitig einplanen.`, time: relAgo(24 * 3600000), read: true, nav: 'prognose' },
